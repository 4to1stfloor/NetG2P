...
for (num_CancerType in Cancerlist) {
  ...
  if (mode == "dual" && data_type == "exp") {
    
    data_tc_link = readRDS(file = paste0(main.path_tc,"/",CancerType,"_exp_pathwaylink_all_log.rds"))
    data_tc_each = readRDS(file = paste0(main.path_tc,"/",CancerType,"_exp_pathwayeach_all_log.rds"))
  ...
  } else if (mode == "dual" && data_type == "mut") {
    
    data_tc_link = readRDS(file = paste0(main.path_tc,"/",CancerType,"_mut_pathwaylink_all_log.rds"))
    data_tc_each = readRDS(file = paste0(main.path_tc,"/",CancerType,"_mut_pathwayeach_all_log.rds"))
  ...
  } else if (mode == "dual" && data_type == "net") {
    ...
    if (type == "link" && data_type == "exp") {
      
      data_tc = readRDS(file = paste0(main.path_tc,"/",CancerType,"_exp_pathwaylink_all_log.rds"))
      # data_tc = data_tc[,-which(dim(data_tc)[1] == colSums(data_tc[,-length(colnames(data_tc))]))]
      
    } else if (type == "link" && data_type == "mut") {
      data_tc = readRDS(file = paste0(main.path_tc,"/",CancerType,"_mut_pathwaylink_all_log.rds"))
      # data_tc = data_tc[,-which(dim(data_tc)[1] == colSums(data_tc[,-length(colnames(data_tc))]))]
      
    } else if (type == "link" && data_type == "net") {
      
      data_tc = readRDS(file = paste0(main.path_tc,"/",CancerType,"_pathwaylink_all_log.rds"))
      # data_tc = data_tc[,-which(dim(data_tc)[1] == colSums(data_tc[,-length(colnames(data_tc))]))]
      
    } else if (type == "each" && data_type == "exp") {
      data_tc = readRDS(file = paste0(main.path_tc,"/",CancerType,"_exp_pathwayeach_all_log.rds"))
      # data_tc = data_tc[,-which(dim(data_tc)[1] == colSums(data_tc[,-length(colnames(data_tc))]))
      
    } else if (type == "each" && data_type == "mut") {
      data_tc = readRDS(file = paste0(main.path_tc,"/",CancerType,"_mut_pathwayeach_all_log.rds"))
      
    } else if (type == "each" && data_type == "net") {
