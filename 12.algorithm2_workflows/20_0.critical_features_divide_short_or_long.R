...
surv_total_results = read.xlsx("~/nas/04.Results/Total_results_survpval2.xlsx")
...
for (num_CancerType in Cancerlist) {
  ...
  write.xlsx(cancer_short_long , paste0("~/nas/04.Results/short_long/",CancerType,"_critical_features_short_long.xlsx"))
