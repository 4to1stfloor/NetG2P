...
for (num_CancerType in Cancerlist) {
  ...
  if (length(long_gene) != 0 && length(short_gene) != 0 ) {
    ...
    for (prognosis in c("short","long")) {
      ...
      heatmap_sim = heatmapPlot(get(paste0("simMatrix_",prognosis)),
                                get(paste0("reducedTerms_",prognosis)),
                                annotateParent=TRUE,
      ...
      scatter_mat = scatterPlot_edit(get(paste0("simMatrix_",prognosis)), get(paste0("reducedTerms_",prognosis)))
      ...
      tree_mat = treemapPlot(get(paste0("reducedTerms_",prognosis)))
    ...
    heatmap_sim = heatmapPlot(simMatrix_short,
                              reducedTerms_short,
                              annotateParent=TRUE,
                              annotationLabel="parentTerm",
                              fontsize=6)
    ...
    scatter_mat = scatterPlot_edit(simMatrix_short, reducedTerms_short)
    ...
    tree_mat = treemapPlot(reducedTerms_short)
    ...
    heatmap_sim = heatmapPlot(simMatrix_long,
                              reducedTerms_long,
                              annotateParent=TRUE,
                              annotationLabel="parentTerm",
                              fontsize=6)
    ...
    scatter_mat = scatterPlot_edit(simMatrix_long, reducedTerms_long)
    ...
    tree_mat = treemapPlot(reducedTerms_long)
