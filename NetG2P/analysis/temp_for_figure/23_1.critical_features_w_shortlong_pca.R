...
saveRDS(total_pca_df_filt, "~/nas/04.Results/PCA_tsne/total_cancer_pat_for_PCA.rds")
saveRDS(pca_rank2_add_meta , "~/nas/04.Results/PCA_tsne/total_cancer_pat_for_PCA_meta.rds")
