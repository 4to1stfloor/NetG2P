...
for (num_CancerType in Cancerlist) {
  ...
  png(filename = paste0(CancerType,"_dual_features_w_short_long_clusterT_surv.png"),
  ...
  png(filename = paste0(CancerType,"_dual_features_w_short_long_clusterF_surv.png"),
      width = 35, height = 35,  units = "cm" ,pointsize = 12,
      bg = "white", res = 1200, family = "")
  ...
  png(filename = paste0(CancerType,"_dual_features_w_short_long_complex_surv.png"),
      width = 35, height = 35,  units = "cm" ,pointsize = 12,
      bg = "white", res = 1200, family = "")
  ...
  png(filename = paste0(CancerType,"_exp_features_w_short_long_clusterT_surv.png"),
      width = 35, height = 35,  units = "cm" ,pointsize = 12,
      bg = "white", res = 1200, family = "")
  ...
  png(filename = paste0(CancerType,"_exp_features_w_short_long_clusterF_surv.png"),
      width = 35, height = 35,  units = "cm" ,pointsize = 12,
      bg = "white", res = 1200, family = "")
  ...
  png(filename = paste0(CancerType,"_exp_features_w_short_long_complex_surv.png"),
      width = 35, height = 35,  units = "cm" ,pointsize = 12,
      bg = "white", res = 1200, family = "")
